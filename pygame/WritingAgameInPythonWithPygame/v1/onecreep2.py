...
class Creep(pygame.sprite.Sprite):
    ...
    def __init__(self,screen,game,init_position,init_direction,speed):
        ...
        self.speed = speed
        self.initImages()
        self.pos = Vector(init_position)
        self.prev_pos = self.pos
        self.direction = Vector(init_direction).getNormalized()
...
#              self.direction = Vector( next_coord[1] - coord[1], next_coord[0] - coord[0] ).getNormalized()
    ...
    def draw(self):
        if self.state == Creep.ALIVE:
            ...
            self.draw_rect.center = tuple(self.pos)
...
class Game(GameHelper):
    ...
    def screenToCoord(self,pos):
        ...
        x,y = pos.x - self.field_rect.left, pos.y - self.field_rect.top
