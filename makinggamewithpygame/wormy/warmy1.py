        ...
        for e in pygame.event.get():
            if e.type == QUIT:
                ...
                if (e.key == K_LEFT or e.key == K_a) and direction != right:
                    ...
                    terminate()
        # check if worm has it itself or the edge
        if wormcoords[head]['x'] == -1 or wormcoords[head]['x'] == cellwidth: return
        if wormcoords[head]['y'] == -1 or wormcoords[head]['y'] == cellheight: return
