...
FPS = 25 #30 # frames per second to update the screen
WINWIDTH,WINHEIGHT = 800,600 #640,480 # width of the program's window, in pixels
...
SQUIRRELMINSPEED = 2#3 # slowest squirrel speed
