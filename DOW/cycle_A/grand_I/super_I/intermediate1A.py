...
#--------------------------------------------#
#  intermediate I(A) of primaryI(of superI)     #
#--------------------------------------------#
...
class Intermediate(Impulse):
    ...
    def create_minors(self):
        ...
        minor3 = Impulse(22080,21640,level=self.level-1,No=3,has_subwaves=False)
        minor4 = ZigZag (21640,21800,level=self.level-1,No=4,has_subwaves=False)
...
if __name__ == '__main__':
    ...
    intermidate1.create_xls(book,'intermediate1a.xls')
    os.system('start intermediate1a.xls')
