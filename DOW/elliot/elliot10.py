...
class EWaves:
    ...
    def predict_wave3(self,wave1,a):
        ...
        print 
        print fg.CYAN + bg.WHITE +  '\tpredict Wave III = 2.0*I and Wave V = 2.38*I\t\t\t'
...
#       print 'p1 : %d\tp3 : %d\t p5 : %d' %(p1,p3,p5)
    def predict_wave4(self,wave1,wave2,wave3,a,b,c):
        ...
        p4 = p3 - c/2.382
        p5 = p4 + a
        print fg.CYAN + bg.WHITE + '\tpredict wave IV = III - III/2.382\t\t\t\t'
    ...
    def predict_wave5(self,wave1,wave2,wave3,wave4,a,b,c,d):
        ...
        print fg.CYAN + bg.WHITE + '\tpredict wave V = IV + 1.0*I\t\t\t\t\t'
    ...
    def analyze(self,waves):
        ...
        self.Fib_5 = e/a
        print
        print fg.GREEN + bg.WHITE +'\tanalyze Elliot Wave \t\t\t\t\t\t'
        #print fg.CYAN +'a : %d\tb : %d\tc : %d\td : %d\t e : %d' %(self.a, self.b, self.c, self.d, self.e)
        print fg.GREEN +'< Wave started at %d>' %p0
        print 'p1 : %d\t p2 : %d\t p3 : %d\t p4 : %d\t p5 : %d' %(p1,p2,p3,p4,p5)
        print fg.GREEN +'< Sizes(Percent) >'
        print 'a:%d(%.1f%%)  b:%d(%.1f%%)  c:%d(%.1f%%)  d:%d(%.1f%%)  e:%d(%.1f%%)' \
              %(a,wave1.percent, b,wave2.percent, c,wave3.percent, d,wave4.percent, e,wave5.percent)
