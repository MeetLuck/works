...
class Wave(object):
    ...
    def __init__(self,start,end,level,No):
...
if __name__ == '__main__':
    ...
    superV.i   = Impulse(start=6450,end=12391,level=0,No=1)
    superV.ii  = ZigZag(start=12391,end=10404,level=0,No=2)
    superV.iii = Impulse(start=10404,end=18351,level=0,No=3)
    superV.iv  = Flat(start=18351,end=15450,level=0,No=4)
    superV.v   = Impulse(start=15450,end=None,level=0,No=5)
    superV.subwaves = superV.i,superV.ii,superV.iii,superV.iv,superV.v
