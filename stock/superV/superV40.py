...
def superV():
    def set_primaries():
        ...
        superwaveV.i.set_motives(start=6450,p1=8877,p2=8077,p3=10729,p4=9614,p5=12391)
        superwaveV.ii.set_correctives(start=12351,pa=11556,pb=12876,pc=10404)
        superwaveV.iii.set_motives(start=10404,p1=13300,p2=12035,p3=16588,p4=15355,p5=18351)
        #superwaveV.iii.set_motives(start=10404,p1=13662,p2=12471,p3=17279,p4=15885,p5=18351)
        superwaveV.iv.set_correctives(start=18351,pa=15370,pb=17987,pc=15450)
        superwaveV.v.set_motives(start=15450,p1=18167,p2=17140,p3=21170,p4=20375,p5=None)

#   print fg.RED +'superwave [V] Analysis : I,II,III,IV,V\n'
    print_title(fg.RED,'superwave [V] Analysis')
    superwaveV = Motive(start=6450, end=None, level=+1, no=5) 
    superwaveV.set_motives(start=6450,p1=12391,p2=10404,p3=18351,p4=15450,p5=None)
    set_primaries()
    superwaveV.report()
